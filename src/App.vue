      ...
      <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
          <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <!-- Mobile menu button-->
            <DisclosureButton
              class="relative inline-flex items-center justify-between rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
          ...
          <div class="left flex flex-shrink-0 items-center">
          ...
          <div class="flex flex-1 items-center justify-between sm:items-stretch sm:justify-center">
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                ...
                ]" :aria-current="item.current ? 'page' : undefined" @click="togle(item.current)">{{ item.name
}}</router-link>
          ...
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button type="button"
              ...
              <BellIcon class="ml-1 h-9 w-9" aria-hidden="true" />
            </button>
