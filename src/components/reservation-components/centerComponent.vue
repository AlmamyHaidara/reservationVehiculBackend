<template>
    ...
    <div class="bg-white">
        ...
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <div
                class="grid grid-cols-auto gap-x-6 gap-y-10 sm:grid-cols-auto lg:grid-cols-auto xl:grid-cols-auto xl:gap-x-8 mx-auto">
                <a href="#" class="group">
                    <div
                ...
                <a href="#" class="group">
                    <div
                        ...
                        <img src="https://tailwindui.com/img/ecommerce-images/category-page-04-image-card-04.jpg"
                            ...
                            class="h-72 w-full object-cover object-center group-hover:opacity-75">
                    </div>
